"""Detect browser/device fingerprinting candidates from HTTP request evidence.

This engine intentionally uses an explainable attribute co-occurrence heuristic.
It does not claim population-based entropy or uniqueness without an empirical
frequency baseline for the observed attributes.
"""
